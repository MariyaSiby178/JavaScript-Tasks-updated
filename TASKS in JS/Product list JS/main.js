...
function addrowFunction() {
  ...
  index++;
  newRow.innerHTML = "<tr><td>" + index + "</td></td>";
  newRow.innerHTML +=
    "<td><input type='text' id='mark_" +
    index +
    "'  onkeyup='mark(this.value," +
    index +
    ")' name='mark' class='form-control'></td><td><input type='text' name='percentage' id='percentage_" +
    index +
    "' class='form-control'></td><td><input type='text' name='grade' id='grade_" +
    index +
